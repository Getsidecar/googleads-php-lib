...
if (!class_exists("BudgetService", false)) {
  ...
  class BudgetService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201809";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201809/BudgetService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201809/BudgetService";
    /**

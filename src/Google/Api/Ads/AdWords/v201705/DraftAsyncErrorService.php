...
if (!class_exists("DraftAsyncErrorService", false)) {
  ...
  class DraftAsyncErrorService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201809";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201809/DraftAsyncErrorService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201809/DraftAsyncErrorService";
    /**

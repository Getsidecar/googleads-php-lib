...
if (!class_exists("CampaignBidModifierService", false)) {
  ...
  class CampaignBidModifierService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201809";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201809/CampaignBidModifierService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201809/CampaignBidModifierService";
    /**

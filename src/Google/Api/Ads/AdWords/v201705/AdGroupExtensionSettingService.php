...
if (!class_exists("AdGroupExtensionSettingService", false)) {
  ...
  class AdGroupExtensionSettingService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201809";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201809/AdGroupExtensionSettingService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201809/AdGroupExtensionSettingService";
    /**
